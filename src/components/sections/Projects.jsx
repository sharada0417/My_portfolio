    ...
    >
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
          {/* Project Card */}
          <div className="p-6 rounded-xl border border-white/20 hover:-translate-y-1 hover:border-blue-400/40 hover:shadow-[0_2px_12px_rgba(59,130,246,0.3)] transition">
